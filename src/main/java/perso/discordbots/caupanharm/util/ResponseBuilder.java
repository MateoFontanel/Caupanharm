...
public class ResponseBuilder {
    ...
    public static InteractionApplicationCommandCallbackReplyMono build(DeferrableInteractionEvent event, String content, List<EmbedCreateSpec> embeds, boolean ephemeral, boolean pingable) {
        return event.reply()
    ...
    public static InteractionReplyEditMono buildDeferred(DeferrableInteractionEvent event, String content, List<EmbedCreateSpec> embeds, boolean pingable) {
